...
//    AP_CFG_RDEB_WIFI_CUSTOM_LID,
	...
	AP_CFG_RESERVED_10,
/* BUG1039 - Add NVRAM */
    AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_RESULT_LID,
    AP_CFG_CUSTOM_FILE_CUST_IN_SW_LID,
    AP_CFG_CUSTOM_FILE_CUST_COUNTRY_CODE_LID,
    AP_CFG_CUSTOM_FILE_CUST_PCB_SW_LID,
    AP_CFG_CUSTOM_FILE_CCI_SW_LID,
    AP_CFG_CUSTOM_FILE_CUST_EX_SW_LID,
    AP_CFG_CUSTOM_FILE_HW_LID,
    AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID,
    AP_CFG_REEB_FILE_WARRANTY_INFO_LID,
/* BUG1039 - Add NVRAM */
...
/* BUG1039 - Add NVRAM */
#define AP_CFG_CUSTOM_FILE_P_SENSOR_THRESHOLD_RESULT_LID_VERNO  "000"
#define AP_CFG_CUSTOM_FILE_CUST_IN_SW_LID_VERNO            "000"
#define AP_CFG_CUSTOM_FILE_CUST_COUNTRY_CODE_LID_VERNO            "000"
#define AP_CFG_CUSTOM_FILE_CUST_PCB_SW_LID_VERNO           "000"
#define AP_CFG_CUSTOM_FILE_CCI_SW_LID_VERNO            "000"
#define AP_CFG_CUSTOM_FILE_CUST_EX_SW_LID_VERNO            "000"
#define AP_CFG_CUSTOM_FILE_HW_LID_VERNO                "000"
#define AP_CFG_CUSTOM_FILE_FTM_TEST_RESULT_LID_VERNO       "000"
#define AP_CFG_REEB_FILE_WARRANTY_INFO_LID_VERNO    "000"
/* BUG1039 - Add NVRAM */
