...
void GC0313MIPINightMode(kal_bool bEnable)
{
	...
	{	
		...
		if(GC0313MIPI_MPEG4_encode_mode == KAL_TRUE)
			GC0313MIPI_write_cmos_sensor(0x33, 0x10); // 15~7.5FPS
		else
	...
	else 
	{
		...
		if(GC0313MIPI_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0313MIPI_write_cmos_sensor(0x33, 0x20);
           	       GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
			GC0313MIPIGammaSelect(GC0313MIPI_RGB_Gamma_m1);				   
...
void GC0313MIPI_Sensor_Init(void)
{
	...
	GC0313MIPI_write_cmos_sensor(0x77 , 0x6b);
	GC0313MIPI_write_cmos_sensor(0x78 , 0x40);
	GC0313MIPI_write_cmos_sensor(0x79 , 0x4e);
	...
	/////////////////// ISP Realated ////////////////////
	/////////////////////////////////////////////////////
    GC0313MIPI_write_cmos_sensor(0x40, 0x5f);
    GC0313MIPI_write_cmos_sensor(0x41, 0x20);
    GC0313MIPI_write_cmos_sensor(0x42, 0x02);
    ...
    GC0313MIPI_write_cmos_sensor(0x33, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x34, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x35, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x36, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x37, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x38, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x39, 0x18); //1a   20
    GC0313MIPI_write_cmos_sensor(0x3a, 0x18); //1a   20
    ...
    GC0313MIPI_write_cmos_sensor(0xb1, 0x20);
    GC0313MIPI_write_cmos_sensor(0xb2, 0x07);
    GC0313MIPI_write_cmos_sensor(0xb3, 0xf6);
    GC0313MIPI_write_cmos_sensor(0xb4, 0xe1);
	GC0313MIPI_write_cmos_sensor(0xb5, 0x29);
	GC0313MIPI_write_cmos_sensor(0xb6, 0x24);
	GC0313MIPI_write_cmos_sensor(0xb7, 0xdf);
	GC0313MIPI_write_cmos_sensor(0xb8, 0xfd);
	
	////////////////////////////////////////////////////
	/////////////////////// DNDD ///////////////////////
	////////////////////////////////////////////////////
	GC0313MIPI_write_cmos_sensor(0x7e, 0x12);
	GC0313MIPI_write_cmos_sensor(0x7f, 0xc3);
	GC0313MIPI_write_cmos_sensor(0x82, 0x7c);
	GC0313MIPI_write_cmos_sensor(0x84, 0x02);
	GC0313MIPI_write_cmos_sensor(0x89, 0xa4);
	...
	GC0313MIPI_write_cmos_sensor(0x95, 0x64);
	...
	GC0313MIPI_write_cmos_sensor(0xaa, 0x50);
    ...
    GC0313MIPI_write_cmos_sensor(0xbf, 0x0e);
    GC0313MIPI_write_cmos_sensor(0xc0, 0x20);
    GC0313MIPI_write_cmos_sensor(0xc1, 0x3f);
    GC0313MIPI_write_cmos_sensor(0xc2, 0x50);
    GC0313MIPI_write_cmos_sensor(0xc3, 0x62);
    GC0313MIPI_write_cmos_sensor(0xc4, 0x75);
    GC0313MIPI_write_cmos_sensor(0xc5, 0x87);
    GC0313MIPI_write_cmos_sensor(0xc6, 0x99);
    GC0313MIPI_write_cmos_sensor(0xc7, 0xab);
    GC0313MIPI_write_cmos_sensor(0xc8, 0xbf);
    GC0313MIPI_write_cmos_sensor(0xc9, 0xce);
	GC0313MIPI_write_cmos_sensor(0xca, 0xd9);
	...
	////////////////////////////////////////////////////
    GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
    GC0313MIPI_write_cmos_sensor(0x10, 0x08);
    GC0313MIPI_write_cmos_sensor(0x11, 0x11);
    GC0313MIPI_write_cmos_sensor(0x12, 0x13);
    GC0313MIPI_write_cmos_sensor(0x13, 0x58); //AE target
    ...
    GC0313MIPI_write_cmos_sensor(0x2b, 0x02); //L0 15fps
    GC0313MIPI_write_cmos_sensor(0x2c, 0x30);
    GC0313MIPI_write_cmos_sensor(0x2d, 0x02); //L115~11fps
    GC0313MIPI_write_cmos_sensor(0x2e, 0xd0);
    GC0313MIPI_write_cmos_sensor(0x2f, 0x03); //L215~8fps
    GC0313MIPI_write_cmos_sensor(0x30, 0xc0);
    GC0313MIPI_write_cmos_sensor(0x31, 0x07); //L3 15~4fps
    GC0313MIPI_write_cmos_sensor(0x32, 0xd0);
    GC0313MIPI_write_cmos_sensor(0x33, 0x30); //15~4
	...
	////////////////////////////////////////////////////
	GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
	GC0313MIPI_write_cmos_sensor(0xd1, 0x30);
	GC0313MIPI_write_cmos_sensor(0xd2, 0x30);
	GC0313MIPI_write_cmos_sensor(0xde, 0x38);
	GC0313MIPI_write_cmos_sensor(0xd8, 0x15);
	...
	GC0313MIPI_write_cmos_sensor(0x52, 0x24);
	GC0313MIPI_write_cmos_sensor(0x53, 0x08);
	GC0313MIPI_write_cmos_sensor(0x54, 0x0b);
	GC0313MIPI_write_cmos_sensor(0x55, 0x0f);
	GC0313MIPI_write_cmos_sensor(0x56, 0x0b);
	GC0313MIPI_write_cmos_sensor(0x57, 0x20);
	GC0313MIPI_write_cmos_sensor(0x58, 0xf6);
	GC0313MIPI_write_cmos_sensor(0x59, 0x0b);
	...
	GC0313MIPI_write_cmos_sensor(0x67, 0x00);
	...
	GC0313MIPI_write_cmos_sensor(0x71, 0x83);
	GC0313MIPI_write_cmos_sensor(0x72, 0x26);
	GC0313MIPI_write_cmos_sensor(0x73, 0x62);
	GC0313MIPI_write_cmos_sensor(0x74, 0x03);
    ...
    GC0313MIPI_write_cmos_sensor(0x81, 0x68);
	GC0313MIPI_write_cmos_sensor(0x82, 0x60);
	GC0313MIPI_write_cmos_sensor(0x83 , 0xb0); //80//B_gain_limit
	...
	GC0313MIPI_write_cmos_sensor(0xa8, 0x30);
	GC0313MIPI_write_cmos_sensor(0xa9, 0x30);
	GC0313MIPI_write_cmos_sensor(0xaa, 0x30);
	GC0313MIPI_write_cmos_sensor(0xab, 0x30);
	GC0313MIPI_write_cmos_sensor(0xac, 0x30);
	GC0313MIPI_write_cmos_sensor(0xad, 0x30);
	GC0313MIPI_write_cmos_sensor(0xae, 0x00);
	GC0313MIPI_write_cmos_sensor(0xaf, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb0, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb1, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb2, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb3, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb4, 0x28);
	GC0313MIPI_write_cmos_sensor(0xb5, 0x16);
	GC0313MIPI_write_cmos_sensor(0xb6, 0x10);
	GC0313MIPI_write_cmos_sensor(0xba, 0x4a);
	GC0313MIPI_write_cmos_sensor(0xbb, 0x38);
	GC0313MIPI_write_cmos_sensor(0xbc, 0x2d);
	GC0313MIPI_write_cmos_sensor(0xc0, 0x28);
	GC0313MIPI_write_cmos_sensor(0xc1, 0x1f);
	GC0313MIPI_write_cmos_sensor(0xc2, 0x1c);
	GC0313MIPI_write_cmos_sensor(0xc6, 0x14);
	GC0313MIPI_write_cmos_sensor(0xc7, 0x10);
	GC0313MIPI_write_cmos_sensor(0xc8, 0x0c);
	GC0313MIPI_write_cmos_sensor(0xb7, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb8, 0x00);
	GC0313MIPI_write_cmos_sensor(0xb9, 0x00);
	GC0313MIPI_write_cmos_sensor(0xbd, 0x00);
	GC0313MIPI_write_cmos_sensor(0xbe, 0x00);
	GC0313MIPI_write_cmos_sensor(0xbf, 0x00);
	...
	GC0313MIPI_write_cmos_sensor(0x03 , 0x20); //[5]lane0 delay [4]clk delay
	GC0313MIPI_write_cmos_sensor(0x06 , 0x80); //clock enable
	GC0313MIPI_write_cmos_sensor(0x04 , 0x80); //fifo_pro
	GC0313MIPI_write_cmos_sensor(0x05 , 0x02);
	GC0313MIPI_write_cmos_sensor(0x11 , 0x1e); //LDI
	GC0313MIPI_write_cmos_sensor(0x12 , 0x00); //LWC
	GC0313MIPI_write_cmos_sensor(0x13 , 0x05);
	GC0313MIPI_write_cmos_sensor(0x15 , 0x12); //10//Dphy mode
	GC0313MIPI_write_cmos_sensor(0x17 , 0x00); //Wdiv
	GC0313MIPI_write_cmos_sensor(0x10 , 0x94); //94
...
{
    	GC0313MIPIGammaSelect(0);//0:use default
}
...
UINT32 GC0313MIPIOpen(void)
{
    ...
    printk("GC0313MIPI Sensor: Parameter Updated at 12/06/2013.\n");
...
UINT32 GC0313MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    /*VV38 bug1515, Louis, 20131028, Sub Camera Cannot record, Start*/
    pSensorResolution->SensorVideoWidth=IMAGE_SENSOR_VIDEO_WIDTH;
    pSensorResolution->SensorVideoHeight=IMAGE_SENSOR_VIDEO_HEIGHT;
    /*VV38 bug1515, Louis, 20131028, Sub Camera Cannot record, End*/
    return ERROR_NONE;
...
/*LVPx bug1229, Louis, 20131015, Camera skip frame , Start*/
#if 1
    /*CCI*/
...
#endif
/*LVPx bug1229, Louis, 20131015, Camera skip frame , End*/
...
BOOL GC0313MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0313MIPI_write_cmos_sensor(0x06, 0xb0);
			GC0313MIPI_write_cmos_sensor(0x07, 0x00); // VB
			GC0313MIPI_write_cmos_sensor(0x08, 0x57);

			GC0313MIPI_SET_PAGE1;
			GC0313MIPI_write_cmos_sensor(0x29, 0x00); // anti-flicker step [11:8]
			GC0313MIPI_write_cmos_sensor(0x2a, 0x73); // anti-flicker step [7:0]
			GC0313MIPI_write_cmos_sensor(0x2b, 0x02); // exp level 0  20 fps
			GC0313MIPI_write_cmos_sensor(0x2c, 0x3f);
			GC0313MIPI_write_cmos_sensor(0x2d, 0x03); // exp level 1  20 ~ 12.5 fps
			GC0313MIPI_write_cmos_sensor(0x2e, 0x98);
			GC0313MIPI_write_cmos_sensor(0x2f, 0x05); // exp level 2  20 ~ 8.3 fps
			GC0313MIPI_write_cmos_sensor(0x30, 0x64);
			GC0313MIPI_write_cmos_sensor(0x31, 0x08); // exp level 3  20 ~ 5 fps
			GC0313MIPI_write_cmos_sensor(0x32, 0xfc);
			GC0313MIPI_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
		    GC0313MIPI_SET_PAGE0;
		    GC0313MIPI_write_cmos_sensor(0x05, 0x01); // HB
		    GC0313MIPI_write_cmos_sensor(0x06, 0xc6);
		    GC0313MIPI_write_cmos_sensor(0x07, 0x00); // VB
		    GC0313MIPI_write_cmos_sensor(0x08, 0x4c);

		    GC0313MIPI_SET_PAGE1;
		    GC0313MIPI_write_cmos_sensor(0x29, 0x00); // anti-flicker step [11:8]
		    GC0313MIPI_write_cmos_sensor(0x2a, 0x5e); // anti-flicker step [7:0]
		    GC0313MIPI_write_cmos_sensor(0x2b, 0x02); // exp level 0 20 fps
		    GC0313MIPI_write_cmos_sensor(0x2c, 0x34);
		    GC0313MIPI_write_cmos_sensor(0x2d, 0x03); // exp level 1 20 ~ 12 fps
		    GC0313MIPI_write_cmos_sensor(0x2e, 0xac);
		    GC0313MIPI_write_cmos_sensor(0x2f, 0x05); // exp level 0 20 ~ 8 fps
		    GC0313MIPI_write_cmos_sensor(0x30, 0x82);
		    GC0313MIPI_write_cmos_sensor(0x31, 0x08); // exp level 0 20 ~ 5 fps
		    GC0313MIPI_write_cmos_sensor(0x32, 0xd0);
		    GC0313MIPI_SET_PAGE0;
		    break;
        default:
...
BOOL GC0313MIPI_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_03:
			GC0313MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0313MIPI_write_cmos_sensor(0x13, 0x5c);
			GC0313MIPI_write_cmos_sensor(0xfe, 0x00);
