...
#if GTP_AUTO_UPDATE
// porting for touch driver start
//mark FW upgrade start
    //#if GTP_HEADER_FW_UPDATE
//mark FW upgrade end
    
//add FW upgrade start
    GTP_INFO("gup_check_update_file() gtp_FW_use_ARRAY = %d", gtp_FW_use_ARRAY);
    if(gtp_FW_use_ARRAY){
//add FW upgrade end
...
// porting for touch driver start
//add FW upgrade start
GTP_INFO("gup_load_section_file() gtp_FW_use_ARRAY = %d", gtp_FW_use_ARRAY);
if(gtp_FW_use_ARRAY){
//add FW upgrade end
...
// porting for touch driver start
//add FW upgrade start
GTP_INFO("gup_update_proc() gtp_FW_use_ARRAY = %d", gtp_FW_use_ARRAY);
if(!gtp_FW_use_ARRAY)
// porting for touch driver end
    _CLOSE_FILE(update_msg.file);
