...
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	/*VV38 Bug 1751, Louis, 20131118, Modify the timing of camera Flash ON , Start*/
	//para.coolTimeOutPara.timOutMs[1]=500;
	para.coolTimeOutPara.timOutMs[1]=300;  //The Max timing from spec is 400ms
	/*VV38 Bug 1751, Louis, 20131118, Modify the timing of camera Flash ON , End*/
