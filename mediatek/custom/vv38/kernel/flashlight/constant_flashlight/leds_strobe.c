...
/*VV3x, Bug1837, Louis, 20131128, Enable Torch mode after DVT2, Start*/
extern int get_cci_hw_id(void);
/*VV3x, Bug1837, Louis, 20131128, Enable Torch mode after DVT2, End*/
...
int FL_Enable(void)
{
	...
	{
		/*VV3x, Bug1837, Louis, 20131128, Enable Torch mode after DVT2, Start*/
		//PK_DBG(" Torch mode get_cci_hw_id=%d\n", get_cci_hw_id());
		//if((1 == get_cci_hw_id()) || (2 == get_cci_hw_id()))
		//{
		  //  PK_DBG(" Torch mode disable on EVT and DVT1\n");
