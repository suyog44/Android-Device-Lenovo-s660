...
#define KEYS_PWRKEY_MAP		{ KEY_POWER, "PwrEnd", 140,  18}

#define DEFINE_KEYS_KEYMAP(x)		\
struct key x[] = {			\
	{ KEY_MENU,       "Menu" ,  120, 600},	\
	{ KEY_HOME,       "Home" ,  300, 600},	\
	{ KEY_BACK,       "Back" ,  450, 600},	\
	{ KEY_VOLUMEUP,   "VLUp" ,  580, 60},	\
	{ KEY_VOLUMEDOWN, "VLDown", 580, 100},	\
}
...
#define CUST_KEY_BACK		KEY_UNKNOWN
