...
#define MAX_CHARGING_TIME                   10*60*60 	// 10hr
...
typedef enum
{
        ...
        TEMP_POS_10_TO_POS_23,
        TEMP_POS_23_TO_POS_45,
...
#define TEMP_POS_23_THRESHOLD  23
#define TEMP_POS_23_THRES_MINUS_X_DEGREE 23
