...
/* [VV38] S Jamie_Chiang BUG#1667 [optical] Rear camera AF driver porting */
#ifdef ORG_VER
                 (MCUDrv::m_LensInitFunc[i].LensId == FM50AF_LENS_ID)
#else
                (MCUDrv::m_LensInitFunc[i].LensId == DW9718AF_LENS_ID)
#endif
/* [VV38] E Jamie_Chiang BUG#1667 [optical] Rear camera AF driver porting */
                )
            {
